...
class ProfileNegoSearchScreen extends StatefulWidget {
  const ProfileNegoSearchScreen({super.key});

  @override
  State<ProfileNegoSearchScreen> createState() =>
      _ProfileNegoSearchScreenState();
}

class _ProfileNegoSearchScreenState extends State<ProfileNegoSearchScreen> {
