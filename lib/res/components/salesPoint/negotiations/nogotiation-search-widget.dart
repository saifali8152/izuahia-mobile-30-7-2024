...
class NegotiationSearchWidget extends StatefulWidget {
  const NegotiationSearchWidget({super.key});

  @override
  State<NegotiationSearchWidget> createState() =>
      _NegotiationSearchWidgetState();
}

class _NegotiationSearchWidgetState extends State<NegotiationSearchWidget> {
  @override
            ...
            SizedBox(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return negotiationSearchItemWidget(onTap: () {});
                  }),
            ),
            15.verticalSpace,
            Padding(
  ...
  Widget negotiationSearchItemWidget({required VoidCallback onTap}) {
    return Container(
