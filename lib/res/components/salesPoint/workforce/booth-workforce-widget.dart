...
class BoothWorkForceWidget extends StatefulWidget {
  const BoothWorkForceWidget({super.key});

  @override
  State<BoothWorkForceWidget> createState() => _BoothWorkForceWidgetState();
}

class _BoothWorkForceWidgetState extends State<BoothWorkForceWidget> {
