...
Widget addUserToWorkForcePopUp(BuildContext context) {
  return const Dialog(
      insetPadding: EdgeInsets.symmetric(horizontal: 20),
      backgroundColor: AppColors.whiteColor,
      child: AddUserToWorkForce());
}

class AddUserToWorkForce extends StatefulWidget {
  const AddUserToWorkForce({super.key});

  @override
  State<AddUserToWorkForce> createState() => _AddUserToWorkForceState();
}

class _AddUserToWorkForceState extends State<AddUserToWorkForce> {
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: DropdownButton(
                      ...
                      underline: Container(),
                      icon: const Icon(Icons.keyboard_arrow_down),
                      items: boothtItems.map((String items) {
                        return DropdownMenuItem(
                          value: items,
                          child: Text(
                            items,
