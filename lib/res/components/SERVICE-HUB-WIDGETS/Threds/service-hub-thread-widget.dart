...
class ServiceHubThreadWidget extends StatefulWidget {
  const ServiceHubThreadWidget({super.key});

  @override
  State<ServiceHubThreadWidget> createState() => _ServiceHubThreadWidgetState();
}

class _ServiceHubThreadWidgetState extends State<ServiceHubThreadWidget> {
