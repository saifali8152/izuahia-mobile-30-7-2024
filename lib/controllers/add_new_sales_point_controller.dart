...
class AddSalesPointController extends GetxController {
  GlobalKey<FormState>? salesPointFormKey;
  TextEditingController? salesPointNameController;
  ...
  CreateRequestRepo salesPointRepo = CreateRequestRepo();
  ...
  void onInit() {
    super.onInit();
    salesPointFormKey = GlobalKey<FormState>();
    salesPointNameController = TextEditingController();
  ...
  Future<void> createNewsalesPoint() async {
    await salesPointRepo.addNewSalesPoint(
