...
class QuotesSearchWidget extends StatefulWidget {
  const QuotesSearchWidget({super.key});

  @override
  State<QuotesSearchWidget> createState() => _QuotesSearchWidgetState();
}

class _QuotesSearchWidgetState extends State<QuotesSearchWidget> {
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: AssetImage(Assets.laptop2),
                          fit: BoxFit.cover)),
                ),
                Padding(
