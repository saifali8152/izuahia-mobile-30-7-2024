...
import 'package:izuahia/screens/SERVICEHUB/Quotes/service-hub-quote-search-screen.dart';

class ServiceHubQuotesHomeWidget extends StatefulWidget {
  const ServiceHubQuotesHomeWidget({super.key});

  @override
  State<ServiceHubQuotesHomeWidget> createState() => _ServiceHubQuotesHomeWidgetState();
}

class _ServiceHubQuotesHomeWidgetState extends State<ServiceHubQuotesHomeWidget> {
          ...
          Row(
            ...
            children: [
              ...
              Expanded(child: addButton(onTap: () {
                showDialog(
                  context: context,
                  builder: (context) => createQuotePopUp(context),
                );
              }))
            ],
          ),
  ...
  Widget textField() {
    return SizedBox(
      ...
      child: TextFormField(
        onTap: () {
          Get.to(() => const ServiceHubQuotesSearchScreen());
        },
