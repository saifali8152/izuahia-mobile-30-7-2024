...
import 'package:izuahia/res/dialogs/ProfileSecDialogs/receiptDialogs/receipt-dialogs.dart';
import 'package:izuahia/res/dialogs/salesPointDialogs/receiptDialogs/receipt-details-dialog.dart';

import '../../../res/assets.dart';

class ProfileReceiptSearchScreen extends StatefulWidget {
  const ProfileReceiptSearchScreen({super.key});

  @override
  State<ProfileReceiptSearchScreen> createState() =>
      _ProfileReceiptSearchScreenState();
}

class _ProfileReceiptSearchScreenState
    extends State<ProfileReceiptSearchScreen> {
                ...
                children: [
                  ...
                  Expanded(child: addButton(onTap: () {
                    showDialog(
                        context: context,
                        builder: (_) {
                          return profileAddReceiptPopUp(context);
                        });
                  }))
                ],
              ),
