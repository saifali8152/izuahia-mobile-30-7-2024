            ...
            const Row(
              ...
              children: [
                Text('Purchase of Telecoms Cable',
                    style: TextStyle(
                        fontSize: 10, fontFamily: 'Montserrat', color: AppColors.blackColor, fontWeight: FontWeight.w600)),
                Text('28-02-2024',
                    style:
                        TextStyle(fontSize: 10, fontFamily: 'Montserrat', color: Color(0xff9B9B9B), fontWeight: FontWeight.w600)),
              ],
            ),
            2.verticalSpace,
            const Divider(
                          ...
                          GestureDetector(
                            onTap: () {
                              showDialog(
                                  context: context,
                                  builder: (_) {
                                    return editLedgerPopUp(context);
                                  });
                            },
                            child: Container(
                              height: 24,
...
Widget addLedgerItemWidget({required VoidCallback onTap, required BuildContext context}) {
  return Container(
    // height: Get.height * .17,
    constraints: const BoxConstraints(maxHeight: double.infinity),
    width: Get.width,
        ...
        Row(
          children: [
            const Text('Available Balance:',
                style:
                    TextStyle(fontSize: 10, fontFamily: 'Montserrat', color: AppColors.blackColor, fontWeight: FontWeight.w600)),
            3.horizontalSpace,
            const Text(" \$656700",
                style:
                    TextStyle(fontSize: 12, fontFamily: 'Montserrat', color: AppColors.blackColor, fontWeight: FontWeight.w700)),
          ],
        ),
        2.verticalSpace,
        const Divider(
...
Widget buttonWidget({required String title, required VoidCallback onTap}) {
  return GestureDetector(
    ...
    child: Container(
      ...
      child: Text(title,
          style: TextStyle(
              fontSize: title == 'Add Ledger' ? 10 : 12,
              fontFamily: 'Inter',
