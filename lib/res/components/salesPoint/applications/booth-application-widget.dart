...
class BoothApplicationWidget extends StatefulWidget {
  const BoothApplicationWidget({super.key});

  @override
  State<BoothApplicationWidget> createState() => _BoothApplicationWidgetState();
}

class _BoothApplicationWidgetState extends State<BoothApplicationWidget> {
