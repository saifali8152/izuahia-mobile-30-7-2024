...
class ServiceHubListVacancyScreen extends StatefulWidget {
  const ServiceHubListVacancyScreen({super.key});

  @override
  State<ServiceHubListVacancyScreen> createState() => _ServiceHubListVacancyScreenState();
}

class _ServiceHubListVacancyScreenState extends State<ServiceHubListVacancyScreen> {
