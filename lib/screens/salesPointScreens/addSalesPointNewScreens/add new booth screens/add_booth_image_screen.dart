...
class AddBoothUploadImageScreen extends StatefulWidget {
  const AddBoothUploadImageScreen({super.key});

  @override
  State<AddBoothUploadImageScreen> createState() =>
      _AddBoothUploadImageScreenState();
}

class _AddBoothUploadImageScreenState extends State<AddBoothUploadImageScreen> {
  @override
